...
CREATE TABLE TASK (
    ...
    "LEVEL" TINYINT NOT NULL COMMENT '任务级别',
    REPORT VARCHAR(MAX) NOT NULL COMMENT '任务报告',
...
CREATE TABLE ELAPSE (
    ...
    EXPEND INT NOT NULL COMMENT '消耗时间',
...
CREATE TABLE TEMPLET (
    ...
    TYPE TINYINT NOT NULL COMMENT '模版类型',
    DETAIL VARCHAR(MAX) NOT NULL COMMENT '模版内容'
